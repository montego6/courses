class SubjectStats {
    ...
    createElement() {
        ...
        clone.querySelector('.subject-name').setAttribute('href', `/statistic/courses/by_subject/${this.id}/`)
...
function getStatisticsData() {
    ...
    fetch(`/api/subjects/by_subcategory/${subCatId}/statistics/`).then(response => response.json()).then(data => initializePage(data))
}
